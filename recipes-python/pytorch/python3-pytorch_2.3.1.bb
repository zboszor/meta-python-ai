...
DEPENDSINTEL ?= ""
DEPENDSINTEL:append:x86-64 = "intel-oneapi-mkl intel-oneapi-dpcpp-cpp onednn"

DEPENDS:append:class-target = " \
        zstd-native ${DEPENDSINTEL} \
        tbb glog gloo numactl opencv \
...
EXTRA_OECMAKE_ARCH_FLAGS:append:aarch64 = "\
-DBLAS=Eigen"
...
RDEPENDSINTEL ?= ""
RDEPENDSINTEL:append:x86-64 = "intel-oneapi-mkl intel-oneapi-dpcpp-cpp-runtime onednn"
